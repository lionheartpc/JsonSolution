...
namespace JsonInterfaceClientInfo {
    ...
    public partial class ClientDataSet : global::System.Data.DataSet {
        ...
        public partial class AddressDataTable : global::System.Data.TypedTableBase<AddressRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AddressRow AddAddressRow(string name, string address, string postalCode) {
...
namespace JsonInterfaceClientInfo.ClientDataSetTableAdapters {
    ...
    public partial class AddressTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [client].[Address] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_postalCode = 1 AND [postalCode] IS NULL) OR ([postalCode] = @Original_postalCode)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [client].[Address] ([name], [address], [postalCode]) VALUES (@name, @" +
                "address, @postalCode);\r\nSELECT Id, name, address, postalCode FROM client.Address" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [client].[Address] SET [name] = @name, [address] = @address, [postalCode] = @postalCode WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_postalCode = 1 AND [postalCode] IS NULL) OR ([postalCode] = @Original_postalCode)));
SELECT Id, name, address, postalCode FROM client.Address WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::JsonInterfaceClientInfo.Properties.Settings.Default.ClientConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, address, postalCode FROM client.Address";
        ...
        public virtual int Fill(ClientDataSet.AddressDataTable dataTable) {
        ...
        public virtual ClientDataSet.AddressDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ClientDataSet.AddressDataTable dataTable = new ClientDataSet.AddressDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ClientDataSet.AddressDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_address, string Original_postalCode) {
        ...
        public virtual int Insert(string name, string address, string postalCode) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string address, string postalCode, int Original_Id, string Original_name, string Original_address, string Original_postalCode, int Id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, string postalCode, int Original_Id, string Original_name, string Original_address, string Original_postalCode) {
            return this.Update(name, address, postalCode, Original_Id, Original_name, Original_address, Original_postalCode, Original_Id);
        }
    }
